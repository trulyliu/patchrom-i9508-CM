...
.field private static final OMH_ENABLED:Z = false
...
.field private mDpt:Lcom/android/internal/telephony/dataconnection/CdmaDataProfileTracker;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/telephony/dataconnection/DcTracker;->OMH_ENABLED:Z
...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    invoke-interface {v3, p0, v4, v6}, Lcom/android/internal/telephony/CommandsInterface;->registerForDataNetworkStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-virtual {v3, p0, v4, v6}, Lcom/android/internal/telephony/ServiceStateTracker;->registerForDataRatChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-static {v3, v4, p0, v7, v6}, Lcom/android/internal/telephony/cdma/CdmaSubscriptionSourceManager;->getInstance(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Landroid/os/Handler;ILjava/lang/Object;)Lcom/android/internal/telephony/cdma/CdmaSubscriptionSourceManager;
    ...
    sget-boolean v3, Lcom/android/internal/telephony/dataconnection/DcTracker;->OMH_ENABLED:Z
    ...
    iput-object v4, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mDpt:Lcom/android/internal/telephony/dataconnection/CdmaDataProfileTracker;

    iget-object v3, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mDpt:Lcom/android/internal/telephony/dataconnection/CdmaDataProfileTracker;
    ...
    sget-boolean v4, Lcom/android/internal/telephony/dataconnection/DcTracker;->OMH_ENABLED:Z
...
.method private addDefaultDataProfiles(Ljava/lang/String;)V
    .locals 33
    .parameter "operator"
...
.method private canSetupData(Lcom/android/internal/telephony/dataconnection/ApnContext;)Z
    .locals 8
    .parameter "apnContext"
    ...
    const-string v6, "mms_auto_retrieval"
    ...
    :goto_1
    const-string v6, "mms_auto_on_roaming"
    ...
    .restart local v1       #mmsRetrievalRoaming:Z
    :cond_4
    move v4, v5
...
.method private createAllApnList()V
    ...
    sget-boolean v0, Lcom/android/internal/telephony/dataconnection/DcTracker;->OMH_ENABLED:Z
    ...
    invoke-direct {p0, v7}, Lcom/android/internal/telephony/dataconnection/DcTracker;->addDefaultDataProfiles(Ljava/lang/String;)V
...
.method private onRecordsLoaded()V
    ...
    .prologue
    const-string v1, "onRecordsLoaded"
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mDpt:Lcom/android/internal/telephony/dataconnection/CdmaDataProfileTracker;

    if-eqz v1, :cond_0

    const-string v1, "OMH: onRecordsLoaded(): calling loadProfiles()"

    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/dataconnection/DcTracker;->log(Ljava/lang/String;)V

    iget-object v1, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mDpt:Lcom/android/internal/telephony/dataconnection/CdmaDataProfileTracker;

    invoke-virtual {v1}, Lcom/android/internal/telephony/dataconnection/CdmaDataProfileTracker;->loadProfiles()V

    iget-object v1, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mDpt:Lcom/android/internal/telephony/dataconnection/CdmaDataProfileTracker;

    invoke-virtual {v1}, Lcom/android/internal/telephony/dataconnection/CdmaDataProfileTracker;->isOmhEnabled()Z
...
.method private setupData(Lcom/android/internal/telephony/dataconnection/ApnContext;)Z
    ...
    invoke-virtual {v0, v6}, Lcom/android/internal/telephony/dataconnection/DcTracker;->getApnProfileID(Ljava/lang/String;)I
    ...
    .local v4, apnSetting:Lcom/android/internal/telephony/dataconnection/DataProfile;
    if-nez v4, :cond_0
    ...
    .local v26, mDunApnTypes:[Ljava/lang/String;
    const/16 v24, 0x0

    .local v24, mDefaultApnId:I
    const/4 v6, 0x3
    ...
    .local v25, mDefaultApnTypes:[Ljava/lang/String;
    move-object/from16 v0, p0

    iget-object v6, v0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mRequestedApnType:Ljava/lang/String;
    ...
    .end local v4           #apnSetting:Lcom/android/internal/telephony/dataconnection/DataProfile;
    const-string v6, ""
    ...
    invoke-direct/range {v4 .. v21}, Lcom/android/internal/telephony/dataconnection/ApnSetting;-><init>(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZI)V

    .restart local v4       #apnSetting:Lcom/android/internal/telephony/dataconnection/DataProfile;
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "setupData: CDMA detected and apnSetting == null, use stubbed CDMA APN setting= "
    ...
    .end local v5           #apnId:I
    .end local v17           #types:[Ljava/lang/String;
    .end local v24           #mDefaultApnId:I
    .end local v25           #mDefaultApnTypes:[Ljava/lang/String;
    .end local v26           #mDunApnTypes:[Ljava/lang/String;
    :cond_0
    ...
    .local v22, dcac:Lcom/android/internal/telephony/dataconnection/DcAsyncChannel;
    if-eqz v22, :cond_1

    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/telephony/dataconnection/DcAsyncChannel;->getApnSettingSync()Lcom/android/internal/telephony/dataconnection/DataProfile;

    move-result-object v23

    .local v23, dcacApnSetting:Lcom/android/internal/telephony/dataconnection/DataProfile;
    if-eqz v23, :cond_1

    move-object/from16 v4, v23

    .end local v23           #dcacApnSetting:Lcom/android/internal/telephony/dataconnection/DataProfile;
    :cond_1
    if-nez v22, :cond_5
    ...
    .end local v22           #dcac:Lcom/android/internal/telephony/dataconnection/DcAsyncChannel;
    :goto_1
    return v6

    .restart local v24       #mDefaultApnId:I
    .restart local v25       #mDefaultApnTypes:[Ljava/lang/String;
    .restart local v26       #mDunApnTypes:[Ljava/lang/String;
    :cond_3
    move-object/from16 v17, v25

    .restart local v17       #types:[Ljava/lang/String;
    const/4 v5, 0x0

    .restart local v5       #apnId:I
    goto :goto_0
    ...
    .restart local v22       #dcac:Lcom/android/internal/telephony/dataconnection/DcAsyncChannel;
    :cond_5
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "setupData: dcac="
    ...
    invoke-virtual {v0, v4}, Lcom/android/internal/telephony/dataconnection/ApnContext;->setDataProfile(Lcom/android/internal/telephony/dataconnection/DataProfile;)V
    ...
    invoke-virtual {v0, v1, v6, v2, v3}, Lcom/android/internal/telephony/dataconnection/DcAsyncChannel;->bringUp(Lcom/android/internal/telephony/dataconnection/ApnContext;IILandroid/os/Message;)V
...
.method private setupDataOnConnectableApns(Ljava/lang/String;)V
    ...
    new-array v9, v9, [Lcom/android/internal/telephony/dataconnection/ApnContext;
    ...
    const-string v8, "setupDataOnConnectableApns: isConnectable() call trySetupData"

    invoke-virtual {p0, v8}, Lcom/android/internal/telephony/dataconnection/DcTracker;->log(Ljava/lang/String;)V

    iget-object v8, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mDpt:Lcom/android/internal/telephony/dataconnection/CdmaDataProfileTracker;
    ...
    invoke-virtual {v8, v9}, Lcom/android/internal/telephony/dataconnection/CdmaDataProfileTracker;->getDataProfile(Ljava/lang/String;)Lcom/android/internal/telephony/dataconnection/DataProfile;
    ...
    .local v7, temp:Lcom/android/internal/telephony/dataconnection/DataProfile;
    invoke-virtual {v7}, Lcom/android/internal/telephony/dataconnection/DataProfile;->toHash()Ljava/lang/String;

    move-result-object v8

    invoke-virtual {v2}, Lcom/android/internal/telephony/dataconnection/DataProfile;->toHash()Ljava/lang/String;
    ...
    const-string v9, "Skip addition of duplicate profile, dp="
    ...
    .end local v7           #temp:Lcom/android/internal/telephony/dataconnection/DataProfile;
    :cond_2
    if-nez v3, :cond_3
...
.method private tryRestartDataConnections(Ljava/lang/String;)V
    ...
    :goto_1
    invoke-virtual {p0, v4, p1}, Lcom/android/internal/telephony/dataconnection/DcTracker;->cleanUpAllConnections(ZLjava/lang/String;)V
...
.method private trySetupData(Lcom/android/internal/telephony/dataconnection/ApnContext;)Z
    ...
    .local v2, waitingDps:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/dataconnection/DataProfile;>;"
    ...
    :cond_5
    invoke-virtual {p1, v2}, Lcom/android/internal/telephony/dataconnection/ApnContext;->setWaitingDataProfiles(Ljava/util/ArrayList;)V

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "trySetupData: Create from mAllDps : "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mAllDps:Ljava/util/ArrayList;
    ...
    .end local v2           #waitingDps:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/dataconnection/DataProfile;>;"
    :cond_6
    new-instance v3, Ljava/lang/StringBuilder;
...
.method protected cleanUpConnection(ZLcom/android/internal/telephony/dataconnection/ApnContext;)V
    ...
    :cond_2
    :goto_1
    iget-object v4, p0, Lcom/android/internal/telephony/dataconnection/DcTracker;->mDpt:Lcom/android/internal/telephony/dataconnection/CdmaDataProfileTracker;
...
.method protected getUiccCardApplication()Lcom/android/internal/telephony/uicc/IccRecords;
    ...
    const-string v2, "getUiccCardApplication "
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-direct {p0, v2, v3}, Lcom/android/internal/telephony/dataconnection/DcTracker;->trySetupData(Ljava/lang/String;Ljava/lang/String;)Z
...
.method protected onUpdateIcc()V
    ...
    invoke-virtual {p0}, Lcom/android/internal/telephony/dataconnection/DcTracker;->getUiccCardApplication()Lcom/android/internal/telephony/uicc/IccRecords;
    ...
    const-string v4, "onUpdateIcc: newIccRecords "
    ...
    const-string v4, "New records found "
