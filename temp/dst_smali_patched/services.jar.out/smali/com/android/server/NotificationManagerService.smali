...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/StatusBarManagerService;Lcom/android/server/LightsService;)V
    ...
    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mForegroundToken:Landroid/os/IBinder;

    const/4 v11, 0x1

    iput-boolean v11, p0, Lcom/android/server/NotificationManagerService;->mScreenOn:Z

    const/4 v11, 0x0

    iput-boolean v11, p0, Lcom/android/server/NotificationManagerService;->mDreaming:Z

    const/4 v11, 0x0

    iput-boolean v11, p0, Lcom/android/server/NotificationManagerService;->mInCall:Z

    new-instance v11, Ljava/util/ArrayList;

    invoke-direct {v11}, Ljava/util/ArrayList;-><init>()V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mNotificationList:Ljava/util/ArrayList;

    new-instance v11, Ljava/util/ArrayList;

    invoke-direct {v11}, Ljava/util/ArrayList;-><init>()V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mLights:Ljava/util/ArrayList;

    const/4 v11, 0x0

    iput-boolean v11, p0, Lcom/android/server/NotificationManagerService;->mQuietHoursEnabled:Z

    const/4 v11, 0x0

    iput v11, p0, Lcom/android/server/NotificationManagerService;->mQuietHoursStart:I

    const/4 v11, 0x0

    iput v11, p0, Lcom/android/server/NotificationManagerService;->mQuietHoursEnd:I

    const/4 v11, 0x1

    iput-boolean v11, p0, Lcom/android/server/NotificationManagerService;->mQuietHoursMute:Z

    const/4 v11, 0x1

    iput-boolean v11, p0, Lcom/android/server/NotificationManagerService;->mQuietHoursStill:Z

    const/4 v11, 0x1

    iput-boolean v11, p0, Lcom/android/server/NotificationManagerService;->mQuietHoursDim:Z

    new-instance v11, Ljava/util/ArrayList;

    invoke-direct {v11}, Ljava/util/ArrayList;-><init>()V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mListeners:Ljava/util/ArrayList;

    new-instance v11, Ljava/util/ArrayList;

    invoke-direct {v11}, Ljava/util/ArrayList;-><init>()V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mServicesBinding:Ljava/util/ArrayList;

    new-instance v11, Ljava/util/HashSet;

    invoke-direct {v11}, Ljava/util/HashSet;-><init>()V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mEnabledListenersForCurrentUser:Ljava/util/HashSet;

    new-instance v11, Ljava/util/HashSet;

    invoke-direct {v11}, Ljava/util/HashSet;-><init>()V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mEnabledListenerPackageNames:Ljava/util/HashSet;

    new-instance v11, Ljava/util/HashSet;

    invoke-direct {v11}, Ljava/util/HashSet;-><init>()V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mBlockedPackages:Ljava/util/HashSet;

    new-instance v11, Lcom/android/server/NotificationManagerService$Archive;

    invoke-direct {v11}, Lcom/android/server/NotificationManagerService$Archive;-><init>()V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mArchive:Lcom/android/server/NotificationManagerService$Archive;

    new-instance v11, Lcom/android/server/NotificationManagerService$4;

    invoke-direct {v11, p0}, Lcom/android/server/NotificationManagerService$4;-><init>(Lcom/android/server/NotificationManagerService;)V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mNotificationCallbacks:Lcom/android/server/StatusBarManagerService$NotificationCallbacks;

    new-instance v11, Lcom/android/server/NotificationManagerService$5;

    invoke-direct {v11, p0}, Lcom/android/server/NotificationManagerService$5;-><init>(Lcom/android/server/NotificationManagerService;)V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mVibrator:Landroid/os/Vibrator;

    invoke-static {}, Landroid/app/ActivityManagerNative;->getDefault()Landroid/app/IActivityManager;

    move-result-object v11

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mAm:Landroid/app/IActivityManager;
    ...
    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mUserManager:Landroid/os/UserManager;

    new-instance v11, Ljava/util/ArrayList;

    invoke-direct {v11}, Ljava/util/ArrayList;-><init>()V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mToastQueue:Ljava/util/ArrayList;

    new-instance v11, Lcom/android/server/NotificationManagerService$WorkerHandler;

    const/4 v12, 0x0

    invoke-direct {v11, p0, v12}, Lcom/android/server/NotificationManagerService$WorkerHandler;-><init>(Lcom/android/server/NotificationManagerService;Lcom/android/server/NotificationManagerService$1;)V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mHandler:Lcom/android/server/NotificationManagerService$WorkerHandler;
    ...
    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mAppOps:Landroid/app/AppOpsManager;
    ...
    iget-object v11, p0, Lcom/android/server/NotificationManagerService;->mNotificationCallbacks:Lcom/android/server/StatusBarManagerService$NotificationCallbacks;

    move-object/from16 v0, p2

    invoke-virtual {v0, v11}, Lcom/android/server/StatusBarManagerService;->setNotificationCallbacks(Lcom/android/server/StatusBarManagerService$NotificationCallbacks;)V

    const/4 v11, 0x4

    move-object/from16 v0, p3

    invoke-virtual {v0, v11}, Lcom/android/server/LightsService;->getLight(I)Lcom/android/server/LightsService$Light;

    move-result-object v11

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mNotificationLight:Lcom/android/server/LightsService$Light;
    ...
    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mAttentionLight:Lcom/android/server/LightsService$Light;
    ...
    iput v11, p0, Lcom/android/server/NotificationManagerService;->mDefaultNotificationColor:I
    ...
    iput v11, p0, Lcom/android/server/NotificationManagerService;->mDefaultNotificationLedOn:I
    ...
    iput v11, p0, Lcom/android/server/NotificationManagerService;->mDefaultNotificationLedOff:I

    new-instance v11, Ljava/util/HashMap;

    invoke-direct {v11}, Ljava/util/HashMap;-><init>()V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mNotificationPulseCustomLedValues:Ljava/util/HashMap;

    new-instance v11, Ljava/util/HashMap;

    invoke-direct {v11}, Ljava/util/HashMap;-><init>()V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mPackageNameMappings:Ljava/util/Map;
    ...
    iget-object v11, p0, Lcom/android/server/NotificationManagerService;->mPackageNameMappings:Ljava/util/Map;
    ...
    sget-object v13, Lcom/android/server/NotificationManagerService;->DEFAULT_VIBRATE_PATTERN:[J

    invoke-static {v9, v11, v12, v13}, Lcom/android/server/NotificationManagerService;->getLongArray(Landroid/content/res/Resources;II[J)[J

    move-result-object v11

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mDefaultVibrationPattern:[J
    ...
    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mFallbackVibrationPattern:[J
    ...
    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mNoAlertsVibrationPattern:[J
    ...
    iput v11, p0, Lcom/android/server/NotificationManagerService;->mDisabledNotifications:I
    ...
    const-string v11, "android.intent.action.USER_STOPPED"
    ...
    iget-object v12, p0, Lcom/android/server/NotificationManagerService;->mIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {v7, v11}, Landroid/content/IntentFilter;->addDataScheme(Ljava/lang/String;)V
    ...
    new-instance v8, Lcom/android/server/NotificationManagerService$QuietHoursSettingsObserver;

    iget-object v11, p0, Lcom/android/server/NotificationManagerService;->mHandler:Lcom/android/server/NotificationManagerService$WorkerHandler;

    invoke-direct {v8, p0, v11}, Lcom/android/server/NotificationManagerService$QuietHoursSettingsObserver;-><init>(Lcom/android/server/NotificationManagerService;Landroid/os/Handler;)V

    .local v8, qhObserver:Lcom/android/server/NotificationManagerService$QuietHoursSettingsObserver;
    invoke-virtual {v8}, Lcom/android/server/NotificationManagerService$QuietHoursSettingsObserver;->observe()V

    new-instance v11, Lcom/android/server/NotificationManagerService$LEDSettingsObserver;
    ...
    invoke-direct {v11, p0, v12}, Lcom/android/server/NotificationManagerService$LEDSettingsObserver;-><init>(Lcom/android/server/NotificationManagerService;Landroid/os/Handler;)V

    iput-object v11, p0, Lcom/android/server/NotificationManagerService;->mSettingsObserver:Lcom/android/server/NotificationManagerService$LEDSettingsObserver;

    iget-object v11, p0, Lcom/android/server/NotificationManagerService;->mSettingsObserver:Lcom/android/server/NotificationManagerService$LEDSettingsObserver;

    invoke-virtual {v11}, Lcom/android/server/NotificationManagerService$LEDSettingsObserver;->observe()V
...
.method static synthetic access$2000(Lcom/android/server/NotificationManagerService;)Lcom/android/server/NotificationManagerService$LEDSettingsObserver;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2500(Lcom/android/server/NotificationManagerService;)Ljava/util/HashMap;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2600(Lcom/android/server/NotificationManagerService;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2802(Lcom/android/server/NotificationManagerService;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2902(Lcom/android/server/NotificationManagerService;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$3400(Lcom/android/server/NotificationManagerService;Lcom/android/server/NotificationManagerService$ToastRecord;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private updateLightsLocked()V
    ...
    iget-boolean v7, p0, Lcom/android/server/NotificationManagerService;->mDreaming:Z
...
.method public enqueueNotificationInternal(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;ILandroid/app/Notification;[II)V
    ...
    .local v30, isSystemNotification:Z
    :goto_0
    const/4 v8, 0x1
    ...
    .local v36, r:Lcom/android/server/NotificationManagerService$NotificationRecord;
    ...
    .end local v25           #i:I
    .end local v36           #r:Lcom/android/server/NotificationManagerService$NotificationRecord;
    :cond_1
    :goto_2
    return-void

    .end local v13           #user:Landroid/os/UserHandle;
    .end local v30           #isSystemNotification:Z
    :cond_2
    const/16 v30, 0x0
    ...
    .restart local v30       #isSystemNotification:Z
    .restart local v36       #r:Lcom/android/server/NotificationManagerService$NotificationRecord;
    :cond_3
    ...
    new-instance v36, Lcom/android/server/NotificationManagerService$NotificationRecord;
    ...
    check-cast v35, Landroid/app/ProfileManager;

    .local v35, profileManager:Landroid/app/ProfileManager;
    ...
    .local v22, group:Landroid/app/ProfileGroup;
    if-eqz v22, :cond_10
    ...
    .end local v22           #group:Landroid/app/ProfileGroup;
    .end local v35           #profileManager:Landroid/app/ProfileManager;
    :cond_10
    :goto_7
    :try_start_8
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v36 .. v36}, Lcom/android/server/NotificationManagerService$NotificationRecord;->getUserId()I
    ...
    iget-object v7, v0, Lcom/android/server/NotificationManagerService$NotificationRecord;->sbn:Landroid/service/notification/StatusBarNotification;
    ...
    iget-object v8, v0, Lcom/android/server/NotificationManagerService$NotificationRecord;->sbn:Landroid/service/notification/StatusBarNotification;

    invoke-virtual {v8}, Landroid/service/notification/StatusBarNotification;->getBasePkg()Ljava/lang/String;
    ...
    invoke-virtual {v6, v7, v8, v0, v1}, Landroid/os/Vibrator;->vibrate(ILjava/lang/String;[JI)V
    :try_end_b
    ...
    .restart local v28       #inQuietHours:Z
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/server/NotificationManagerService$NotificationRecord;->getNotification()Landroid/app/Notification;
    ...
    .restart local v15       #alertsDisabled:Z
    :cond_26
    const/16 v37, 0x0
    ...
    invoke-virtual {v6, v7, v8, v9, v0}, Landroid/os/Vibrator;->vibrate(ILjava/lang/String;[JI)V
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/server/NotificationManagerService$NotificationRecord;->getFlags()I
