.class Landroid/hardware/display/IRemoteDisplayAdapter$Stub$Proxy;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroid/hardware/display/IRemoteDisplayAdapter$Stub;
.end annotation
...
.method constructor <init>(Landroid/os/IBinder;)V
    ...
    iput-object p1, p0, Landroid/hardware/display/IRemoteDisplayAdapter$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public asBinder()Landroid/os/IBinder;
    ...
    .prologue
    iget-object v0, p0, Landroid/hardware/display/IRemoteDisplayAdapter$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public connectRemoteDisplay(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Landroid/hardware/display/IRemoteDisplayAdapter$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public getRemoteDisplayStatus()Landroid/hardware/display/WifiDisplayStatus;
    ...
    :try_start_0
    const-string v3, "android.hardware.display.IRemoteDisplayAdapter"

    invoke-virtual {v0, v3}, Landroid/os/Parcel;->writeInterfaceToken(Ljava/lang/String;)V

    iget-object v3, p0, Landroid/hardware/display/IRemoteDisplayAdapter$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public registerDisplayDevice(Landroid/hardware/display/IDisplayDevice;Ljava/lang/String;IIFILjava/lang/String;Z)V
    ...
    invoke-interface {p1}, Landroid/hardware/display/IDisplayDevice;->asBinder()Landroid/os/IBinder;
...
.method public unregisterDisplayDevice(Landroid/hardware/display/IDisplayDevice;)V
    ...
    .local v0, _data:Landroid/os/Parcel;
    :try_start_0
    const-string v2, "android.hardware.display.IRemoteDisplayAdapter"
