...
.method public onChange(ZLandroid/net/Uri;)V
    ...
    invoke-static {v1, v0}, Landroid/media/AudioService;->access$8302(Landroid/media/AudioService;I)I
    ...
    invoke-static {v1, v2, v4}, Landroid/media/AudioService;->access$5800(Landroid/media/AudioService;IZ)V
    ...
    invoke-static {v1, v2}, Landroid/media/AudioService;->access$8400(Landroid/media/AudioService;Landroid/content/ContentResolver;)V
    ...
    invoke-static {v4, v1}, Landroid/media/AudioService;->access$8502(Landroid/media/AudioService;Z)Z
    ...
    invoke-static {v2, v4}, Landroid/media/AudioService;->access$8700(Landroid/media/AudioService;Landroid/content/ContentResolver;)Z

    move-result v2

    #setter for: Landroid/media/AudioService;->mSafeVolumeEnabled:Z
    invoke-static {v1, v2}, Landroid/media/AudioService;->access$8602(Landroid/media/AudioService;Z)Z
    ...
    invoke-static {v4, v1}, Landroid/media/AudioService;->access$8802(Landroid/media/AudioService;Z)Z
    :try_end_5
