...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static/range {v3 .. v18}, Lcom/android/server/am/ActivityManagerService;->access$300(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ProcessRecord;Ljava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/content/IIntentReceiver;ILjava/lang/String;Landroid/os/Bundle;Ljava/lang/String;IZZIII)I
    ...
    .local v19, inm:Landroid/app/INotificationManager;
    if-eqz v19, :cond_0
    ...
    .end local v19           #inm:Landroid/app/INotificationManager;
    .end local v32           #e:Ljava/lang/RuntimeException;
    :pswitch_14
    move-object/from16 v0, p0
    ...
    .restart local v19       #inm:Landroid/app/INotificationManager;
    if-eqz v19, :cond_0
    ...
    .restart local v32       #e:Ljava/lang/RuntimeException;
    :try_start_27
    const-string v3, "ActivityManager"
    ...
    invoke-static {v3, v4, v0}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_27
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_27 .. :try_end_27} :catch_7
    ...
    .restart local v14       #infoIntent:Landroid/content/Intent;
    .restart local v24       #notification:Landroid/app/Notification;
    .restart local v29       #context:Landroid/content/Context;
    .restart local v46       #process:Lcom/android/server/am/ProcessRecord;
    .restart local v51       #root:Lcom/android/server/am/ActivityRecord;
