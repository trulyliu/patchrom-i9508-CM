...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;Ljava/io/File;Landroid/app/ApplicationErrorReport$CrashInfo;Ljava/lang/String;Landroid/os/DropBoxManager;)V
    ...
    iput-object p3, p0, Lcom/android/server/am/ActivityManagerService$15;->val$report:Ljava/lang/String;

    iput-object p4, p0, Lcom/android/server/am/ActivityManagerService$15;->val$sb:Ljava/lang/StringBuilder;

    iput-object p5, p0, Lcom/android/server/am/ActivityManagerService$15;->val$logFile:Ljava/io/File;

    iput-object p6, p0, Lcom/android/server/am/ActivityManagerService$15;->val$crashInfo:Landroid/app/ApplicationErrorReport$CrashInfo;

    iput-object p7, p0, Lcom/android/server/am/ActivityManagerService$15;->val$dropboxTag:Ljava/lang/String;

    iput-object p8, p0, Lcom/android/server/am/ActivityManagerService$15;->val$dbox:Landroid/os/DropBoxManager;
...
.method public run()V
    ...
    .line 8921
    iget-object v8, p0, Lcom/android/server/am/ActivityManagerService$15;->val$report:Ljava/lang/String;

    if-eqz v8, :cond_0

    .line 8922
    iget-object v8, p0, Lcom/android/server/am/ActivityManagerService$15;->val$sb:Ljava/lang/StringBuilder;

    iget-object v9, p0, Lcom/android/server/am/ActivityManagerService$15;->val$report:Ljava/lang/String;

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    .line 8924
    :cond_0
    iget-object v8, p0, Lcom/android/server/am/ActivityManagerService$15;->val$logFile:Ljava/io/File;
    ...
    iget-object v9, p0, Lcom/android/server/am/ActivityManagerService$15;->val$logFile:Ljava/io/File;
    ...
    :cond_1
    :goto_0
    iget-object v8, p0, Lcom/android/server/am/ActivityManagerService$15;->val$crashInfo:Landroid/app/ApplicationErrorReport$CrashInfo;
    ...
    iget-object v9, p0, Lcom/android/server/am/ActivityManagerService$15;->val$crashInfo:Landroid/app/ApplicationErrorReport$CrashInfo;
    ...
    iget-object v9, p0, Lcom/android/server/am/ActivityManagerService$15;->val$dropboxTag:Ljava/lang/String;
    ...
    iget-object v8, p0, Lcom/android/server/am/ActivityManagerService$15;->this$0:Lcom/android/server/am/ActivityManagerService;
    ...
    :cond_3
    :goto_5
    iget-object v8, p0, Lcom/android/server/am/ActivityManagerService$15;->val$dbox:Landroid/os/DropBoxManager;

    iget-object v9, p0, Lcom/android/server/am/ActivityManagerService$15;->val$dropboxTag:Ljava/lang/String;

    iget-object v10, p0, Lcom/android/server/am/ActivityManagerService$15;->val$sb:Ljava/lang/StringBuilder;
    ...
    iget-object v10, p0, Lcom/android/server/am/ActivityManagerService$15;->val$logFile:Ljava/io/File;
