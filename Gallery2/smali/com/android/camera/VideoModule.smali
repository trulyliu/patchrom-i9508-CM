...
.method private addVideoToMediaStore()Z
    ...
    .line 1480
    iget-object v5, p0, Lcom/android/camera/VideoModule;->mCurrentVideoValues:Landroid/content/ContentValues;
    ...
    :goto_0
    :try_start_0
    iget-object v5, p0, Lcom/android/camera/VideoModule;->mVideoNamer:Lcom/android/camera/VideoModule$VideoNamer;

    invoke-virtual {v5}, Lcom/android/camera/VideoModule$VideoNamer;->getUri()Landroid/net/Uri;

    move-result-object v5

    iput-object v5, p0, Lcom/android/camera/VideoModule;->mCurrentVideoUri:Landroid/net/Uri;
    ...
    iget-object v7, p0, Lcom/android/camera/VideoModule;->mCurrentVideoUri:Landroid/net/Uri;

    invoke-virtual {v5, v6, v7}, Lcom/android/camera/CameraActivity;->addSecureAlbumItemIfNeeded(ZLandroid/net/Uri;)V
    ...
    invoke-virtual {v5, v6}, Lcom/android/camera/CameraActivity;->sendBroadcast(Landroid/content/Intent;)V
    :try_end_0
    ...
    iput-object v5, p0, Lcom/android/camera/VideoModule;->mCurrentVideoFilename:Ljava/lang/String;
    :try_end_1
...
.method private generateVideoFilename(I)V
    ...
    invoke-virtual {v9}, Lcom/android/camera/Storage;->generateDirectory()Ljava/lang/String;
...
.method private initializeEffectsPreview()V
    ...
    iget-object v3, v4, Lcom/android/camera/CameraActivity;->mCameraScreenNail:Lcom/android/gallery3d/ui/ScreenNail;
...
.method private initializeEffectsRecording()V
    ...
    invoke-virtual {v8}, Lcom/android/camera/CameraActivity;->getStorageSpace()J
...
.method private initializeRecorder()V
    ...
    iget-object v15, v15, Lcom/android/camera/CameraActivity;->mCameraDevice:Lcom/android/camera/CameraManager$CameraProxy;
    ...
    iget-object v15, v0, Lcom/android/camera/VideoModule;->mPreviewSurfaceView:Lcom/android/camera/ui/PreviewSurfaceView;

    const/16 v16, 0x0

    invoke-virtual/range {v15 .. v16}, Lcom/android/camera/ui/PreviewSurfaceView;->setVisibility(I)V
    ...
    invoke-virtual {v15}, Lcom/android/camera/CameraActivity;->getIntent()Landroid/content/Intent;
    ...
    iput v15, v0, Lcom/android/camera/VideoModule;->mVideoWidth:I
    ...
    iget v15, v15, Landroid/media/CamcorderProfile;->videoFrameHeight:I

    move-object/from16 v0, p0

    iput v15, v0, Lcom/android/camera/VideoModule;->mVideoHeight:I
    ...
    invoke-virtual {v15}, Lcom/android/camera/CameraActivity;->getStorageSpace()J
...
.method private setCameraParameters()V
    ...
    invoke-static/range {v17 .. v18}, Lcom/android/camera/CameraSettings;->setVideoMode(Landroid/hardware/Camera$Parameters;Z)V
    ...
    invoke-static/range {v17 .. v18}, Lcom/android/camera/CameraSettings;->setEarlyVideoSize(Landroid/hardware/Camera$Parameters;Landroid/media/CamcorderProfile;)V
    ...
    const v20, 0x7f0a00d0

    invoke-virtual/range {v19 .. v20}, Lcom/android/camera/CameraActivity;->getString(I)Ljava/lang/String;

    move-result-object v19

    invoke-virtual/range {v17 .. v19}, Lcom/android/camera/ComboPreferences;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4, v11}, Lcom/android/camera/VideoModule;->isSupported(Ljava/lang/String;Ljava/util/List;)Z
    ...
    invoke-static/range {v16 .. v17}, Lcom/android/camera/VideoModule;->isSupported(Ljava/lang/String;Ljava/util/List;)Z
    ...
    const-string v18, "video-stabilization-supported"

    invoke-virtual/range {v17 .. v18}, Landroid/hardware/Camera$Parameters;->get(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v18, "video-stabilization"
    ...
    invoke-static {v10, v0, v1}, Lcom/android/camera/Util;->getOptimalVideoSnapshotPictureSize(Ljava/util/List;D)Landroid/hardware/Camera$Size;
    ...
    .line 2022
    .local v9, original:Landroid/hardware/Camera$Size;
    ...
    const-string v18, "pref_camera_video_jpeg_key"
    ...
    const-string v18, "pref_camera_video_coloreffect_key"
    ...
    invoke-static/range {v17 .. v17}, Lcom/android/camera/CameraSettings;->readExposure(Lcom/android/camera/ComboPreferences;)I
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/hardware/Camera$Parameters;->getMaxExposureCompensation()I
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/hardware/Camera$Parameters;->getMinExposureCompensation()I
    ...
    invoke-static/range {v17 .. v17}, Lcom/android/camera/Util;->isVideoHdrSupported(Landroid/hardware/Camera$Parameters;)Z
    ...
    const-string v18, "pref_video_hdr_key"
    ...
    invoke-static/range {v17 .. v17}, Lcom/android/camera/CameraSettings;->dumpParameters(Landroid/hardware/Camera$Parameters;)V
    ...
    .end local v5           #jpegQuality:I
    .end local v6           #max:I
    .end local v7           #min:I
    .end local v8           #optimalSize:Landroid/hardware/Camera$Size;
    .end local v9           #original:Landroid/hardware/Camera$Size;
    .end local v10           #supported:Ljava/util/List;,"Ljava/util/List<Landroid/hardware/Camera$Size;>;"
    .end local v11           #supportedFlash:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 1973
    .restart local v11       #supportedFlash:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    :cond_9
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v17 .. v18}, Lcom/android/camera/CameraActivity;->getString(I)Ljava/lang/String;
    ...
    .restart local v5       #jpegQuality:I
    .restart local v6       #max:I
    .restart local v7       #min:I
    .restart local v8       #optimalSize:Landroid/hardware/Camera$Size;
    .restart local v9       #original:Landroid/hardware/Camera$Size;
    .restart local v10       #supported:Ljava/util/List;,"Ljava/util/List<Landroid/hardware/Camera$Size;>;"
    ...
    const-string v19, "invalid exposure range: "
...
.method private startPreview()V
    ...
    sget-boolean v2, Lcom/android/camera/Util;->mSwitchCamera:Z
    ...
    invoke-static {v2, v3, v4}, Lcom/android/camera/Util;->newSurfaceLayer(ILandroid/hardware/Camera$Parameters;Lcom/android/camera/CameraActivity;)Landroid/graphics/SurfaceTexture;
    ...
    .line 950
    :goto_2
    iput-boolean v5, p0, Lcom/android/camera/VideoModule;->mPreviewing:Z
    ...
    iget-object v3, p0, Lcom/android/camera/VideoModule;->mPreviewSurfaceView:Lcom/android/camera/ui/PreviewSurfaceView;

    invoke-virtual {v3}, Lcom/android/camera/ui/PreviewSurfaceView;->getHolder()Landroid/view/SurfaceHolder;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/android/camera/CameraManager$CameraProxy;->setPreviewDisplayAsync(Landroid/view/SurfaceHolder;)V
    :try_end_1
...
.method private startVideoRecording()V
    ...
    invoke-virtual {v1, v5}, Lcom/android/camera/CameraActivity;->setSwipingEnabled(Z)V
    ...
    invoke-virtual {v1}, Lcom/android/camera/CameraActivity;->getOrientationManager()Lcom/android/gallery3d/app/OrientationManager;
...
.method private stopVideoRecording()Z
    ...
    invoke-virtual {v6, v4}, Lcom/android/camera/CameraActivity;->setSwipingEnabled(Z)V

    .line 1749
    iget-object v6, p0, Lcom/android/camera/VideoModule;->mActivity:Lcom/android/camera/CameraActivity;

    invoke-virtual {v6}, Lcom/android/camera/CameraActivity;->showSwitcher()V
    ...
    .line 1761
    iget-object v6, p0, Lcom/android/camera/VideoModule;->mEffectsRecorder:Lcom/android/camera/EffectsRecorder;
    ...
    invoke-virtual {v6}, Lcom/android/camera/CameraActivity;->getOrientationManager()Lcom/android/gallery3d/app/OrientationManager;

    move-result-object v6

    invoke-virtual {v6}, Lcom/android/gallery3d/app/OrientationManager;->unlockOrientation()V
    ...
    .line 1801
    :cond_1
    invoke-direct {p0, v5, v4}, Lcom/android/camera/VideoModule;->setOrientationIndicator(IZ)V
    ...
    iget-object v4, v4, Lcom/android/camera/CameraActivity;->mCameraDevice:Lcom/android/camera/CameraManager$CameraProxy;
    ...
    iget-object v4, v4, Lcom/android/camera/CameraActivity;->mCameraScreenNail:Lcom/android/gallery3d/ui/ScreenNail;

    check-cast v4, Lcom/android/camera/CameraScreenNail;

    iget-object v5, p0, Lcom/android/camera/VideoModule;->mFrameDrawnListener:Lcom/android/camera/CameraScreenNail$OnFrameDrawnListener;

    invoke-virtual {v4, v5}, Lcom/android/camera/CameraScreenNail;->setOneTimeOnFrameDrawnListener(Lcom/android/camera/CameraScreenNail$OnFrameDrawnListener;)V
    ...
    invoke-direct {p0, v6}, Lcom/android/camera/VideoModule;->deleteVideoFile(Ljava/lang/String;)V
...
.method private updateExposureOnScreenIndicator(I)V
    ...
    .prologue
    .line 2276
    iget-object v2, p0, Lcom/android/camera/VideoModule;->mExposureIndicator:Landroid/widget/ImageView;
...
.method private updateHdrOnScreenIndicator()V
    ...
    .prologue
    .line 2417
    iget-object v1, p0, Lcom/android/camera/VideoModule;->mHdrIndicator:Landroid/widget/ImageView;
    ...
    .line 2421
    .local v0, videoHdr:Ljava/lang/String;
    if-eqz v0, :cond_1
...
.method public onSingleTapUp(Landroid/view/View;II)V
    ...
    iget v5, p0, Lcom/android/camera/VideoModule;->mOrientation:I

    invoke-direct {v2, v3, v4, v5}, Lcom/android/camera/ui/RotateTextToast;-><init>(Landroid/app/Activity;II)V
    ...
    iget-boolean v2, p0, Lcom/android/camera/VideoModule;->mSnapshotInProgress:Z
    ...
    .line 2635
    invoke-virtual {p0, v4}, Lcom/android/camera/VideoModule;->dismissPopup(Z)V
    ...
    invoke-static {v2}, Lcom/android/camera/CameraSettings;->dumpParameters(Landroid/hardware/Camera$Parameters;)V
    ...
    new-instance v3, Lcom/android/camera/VideoModule$JpegPictureCallback;

    invoke-direct {v3, p0, v0}, Lcom/android/camera/VideoModule$JpegPictureCallback;-><init>(Lcom/android/camera/VideoModule;Landroid/location/Location;)V

    invoke-virtual {v2, v5, v5, v5, v3}, Lcom/android/camera/CameraManager$CameraProxy;->takePicture(Landroid/hardware/Camera$ShutterCallback;Landroid/hardware/Camera$PictureCallback;Landroid/hardware/Camera$PictureCallback;Landroid/hardware/Camera$PictureCallback;)V

    .line 2650
    invoke-virtual {p0, v4}, Lcom/android/camera/VideoModule;->showVideoSnapshotUI(Z)V

    .line 2651
    iput-boolean v4, p0, Lcom/android/camera/VideoModule;->mSnapshotInProgress:Z
