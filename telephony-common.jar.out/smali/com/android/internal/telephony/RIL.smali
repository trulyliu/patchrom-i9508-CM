...
.field private static final OEM_IDENTIFIER:Ljava/lang/String; = "QUALCOMM"
...
.method static synthetic access$100(Lcom/android/internal/telephony/RIL;)Ljava/lang/Integer;
    .locals 1
    .parameter "x0"
...
.method private broadcastWifiChannelsChangedIntent([B)V
    .locals 7
    .parameter "data"
    ...
    const-string v6, "WifiSafeChannels "
    ...
    const-string v6, "Decoded string "
    ...
    const-string v6, "Parsed channels "
    ...
    .line 3477
    const-string v4, "current_channel"
    ...
    const-string v5, "Broadcasting intent ACTION_SAFE_WIFI_CHANNELS_CHANGED "
    ...
    invoke-static {v2, v4, v5}, Landroid/app/ActivityManagerNative;->broadcastStickyIntent(Landroid/content/Intent;Ljava/lang/String;I)V
    ...
    const-string v6, "Decoding failed: "
...
.method private isQcUnsolOemHookResp(Ljava/nio/ByteBuffer;)Z
    ...
    .line 3366
    .local v1, oem_id_str:Ljava/lang/String;
    const-string v3, "RILJ"
...
.method private processUnsolOemhookResponse(Ljava/nio/ByteBuffer;)V
    ...
    .line 3379
    .local v0, OEMHOOK_UNSOL_CDMA_BURST_DTMF:I
    const v1, 0x803ea

    .line 3380
    .local v1, OEMHOOK_UNSOL_CDMA_CONT_DTMF_START:I
    const v2, 0x803eb

    .line 3381
    .local v2, OEMHOOK_UNSOL_CDMA_CONT_DTMF_STOP:I
    const v4, 0x803f0

    .line 3382
    .local v4, OEMHOOK_UNSOL_WIFI_SAFE_CHANNELS_CHANGED:I
    const v5, 0x803f1

    .line 3383
    .local v5, OEMHOOK_UNSOL_WMS_READY:I
    const v3, 0x803f2

    .line 3385
    .local v3, OEMHOOK_UNSOL_VOICE_SYSTEM_ID:I
    const/4 v7, 0x0

    .local v7, responseId:I
    const/4 v8, 0x0
    ...
    const-string v12, "Response ID in RIL_UNSOL_OEM_HOOK_RAW is "
    ...
    const-string v12, "Response Size is Invalid "
    ...
    const-string v12, " is not served in this process."
    ...
    invoke-virtual {p1, v6, v10, v8}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;
    ...
    const-string v12, ") doesnot match remaining bytes("
    ...
    const-string v12, ") in the buffer. So, don\'t process further"
    ...
    .line 3423
    :pswitch_4
    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/RIL;->notifyWmsReady([B)V
    ...
    const-string v12, "Response voice id in RIL_UNSOL_OEM_HOOK_RAW is "
    ...
    .line 3429
    invoke-virtual {p0, v9}, Lcom/android/internal/telephony/RIL;->notifyVoiceSystemId(I)V

    goto/16 :goto_0

    .line 3433
    :pswitch_6
    invoke-direct {p0, v6}, Lcom/android/internal/telephony/RIL;->broadcastWifiChannelsChangedIntent([B)V
...
.method protected notifyVoiceSystemId(I)V
    .locals 3
    .parameter "data"
    ...
    .line 3496
    .local v0, ar:Landroid/os/AsyncResult;
    iget-object v1, p0, Lcom/android/internal/telephony/RIL;->mVoiceSystemIdRegistrants:Landroid/os/RegistrantList;
    ...
    const-string v2, "VOICE_SYSTEM_ID notified to registrants"
