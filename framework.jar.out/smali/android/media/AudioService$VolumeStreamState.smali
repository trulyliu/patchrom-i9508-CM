...
.method static synthetic access$600(Landroid/media/AudioService$VolumeStreamState;)Z
    .locals 1
    .parameter "x0"
...
.method public declared-synchronized readSettings()V
    ...
    invoke-static {v6}, Landroid/media/AudioService;->access$3800(Landroid/media/AudioService;)Ljava/lang/Boolean;
    ...
    invoke-static {v6}, Landroid/media/AudioService;->access$3900(Landroid/media/AudioService;)Landroid/content/ContentResolver;
    ...
    invoke-static {v6}, Landroid/media/AudioService;->access$4000(Landroid/media/AudioService;)[I
...
.method public declared-synchronized setAllIndexes(Landroid/media/AudioService$VolumeStreamState;)V
    ...
    invoke-static {v5, v3, v6, v7}, Landroid/media/AudioService;->access$4200(Landroid/media/AudioService;III)I
...
.method public declared-synchronized setIndex(II)Z
    ...
    #getter for: Landroid/media/AudioService;->mCameraSoundForced:Ljava/lang/Boolean;
    invoke-static {v7}, Landroid/media/AudioService;->access$3800(Landroid/media/AudioService;)Ljava/lang/Boolean;
    ...
    #getter for: Landroid/media/AudioService;->mCameraSoundForced:Ljava/lang/Boolean;
    invoke-static {v8}, Landroid/media/AudioService;->access$3800(Landroid/media/AudioService;)Ljava/lang/Boolean;
    ...
    invoke-static {v7, v8}, Landroid/media/AudioService;->access$4100(Landroid/media/AudioService;I)I
    ...
    #calls: Landroid/media/AudioService;->rescaleIndex(III)I
    invoke-static {v6, p1, v7, v4}, Landroid/media/AudioService;->access$4200(Landroid/media/AudioService;III)I
    ...
    invoke-static {v6}, Landroid/media/AudioService;->access$4300(Landroid/media/AudioService;)[Landroid/media/AudioService$VolumeStreamState;
    ...
    #calls: Landroid/media/AudioService;->getDeviceForStream(I)I
    invoke-static {v7, v4}, Landroid/media/AudioService;->access$4100(Landroid/media/AudioService;I)I
